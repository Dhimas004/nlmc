...
$query = "SELECT * FROM tb_produk JOIN tb_kategori ON tb_kategori.id_kategori = tb_produk.id_kategori WHERE nama_kategori = 'DOUBLE GLASS' ORDER BY RAND() LIMIT 20";
...
<section id="produk" class="container mb-5">
    <div class="container card shadow py-3">
        <h4 class="font-rubik bg-primary w-lg-25 two-values py-2 px-5 text-white" style="border-radius: 2px 40px; text-indent: 4px;">Produk Double Glass</h4>
        <!-- Owl Carousel -->
