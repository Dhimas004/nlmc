...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="form-group text-center">
                          <img src="../assets/img/kategori/default.png" class="img-profile rounded" id="check_photo" alt="gambar kategori" width="250" height="250">
                          <div class="form-group">
                            <label for="photo">Gambar Kategori</label>
                            <input type="file" name="gambar_kategori" id="photo" class="btn btn-sm btn-primary form-control form-control-file" accept="image/*" required>
                          </div>
                        </div>
                ...
                <table class="table table-bordered table-hover table-striped" id="table_id">
                  <thead>
                    <tr>
                      ...
                      <th style="vertical-align: middle; text-align: center;">Gambar Kategori</th>
                      ...
                      <tr>
                        ...
                        <td valign="top" align="center">
                          <a href="../assets/img/kategori/<?= $dg['gambar_kategori']; ?>" class="enlarge">
                            <img class="img-list-cover" width="150" height="150" src="../assets/img/kategori/<?= $dg['gambar_kategori']; ?>" alt="<?= $dg['gambar_kategori']; ?>">
                          </a>
                        </td>


                        <td valign="top"><?= $dg['nama_kategori']; ?></td>
                        <td valign="top" align="center">
                                  ...
                                  <div class="modal-body">
                                    <div class="form-group text-center">
                                      <a href="../assets/img/kategori/<?= $dg['id_kategori']; ?>" class="enlarge check_enlarge_photo">
                                        <img src="../assets/img/kategori/<?= $dg['gambar_kategori']; ?>" class="img-profile rounded check_photo" alt="cover produk" style="width: 300px; border: 1px solid black;">
                                      </a>
                                      <div class="form-group">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#nav-kategori-produk').addClass('active');
